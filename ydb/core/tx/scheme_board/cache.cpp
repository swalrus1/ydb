...
class TSchemeCache: public TMonitorableActor<TSchemeCache> {
    ...
    public:
        ...
        TString ToJsonString() const {
            ...
            DESCRIPTION_PART(TieredStorageInfo);
        ...
        void Fill(TSchemeBoardEvents::TEvNotifyUpdate& notify) {
            ...
            case NKikimrSchemeOp::EPathTypeTieredStorage:
                Kind = TNavigate::KindTieredStorage;
                FillInfo(Kind, TieredStorageInfo, std::move(*pathDesc.MutableTieredStorageDescription()));
                break;
            ...
            if (IsLikeDirectory(Kind)) {
                ...
                for (const auto& child : pathDesc.GetChildren()) {
                    ...
                    case NKikimrSchemeOp::EPathTypeBackupCollection:
                        ...
                        break;
                    case NKikimrSchemeOp::EPathTypeTieredStorage:
                        ListNodeEntry->Children.emplace_back(name, pathId, TNavigate::KindTieredStorage);
                        break;
                    case NKikimrSchemeOp::EPathTypeTableIndex:
                    case NKikimrSchemeOp::EPathTypeInvalid:
                        Y_DEBUG_ABORT("Invalid path type");
        ...
        void FillEntry(TNavigateContext* context, TNavigate::TEntry& entry, const TResponseProps& props = TResponseProps()) const {
            ...
            entry.TieredStorageInfo = TieredStorageInfo;
        }
    ...
    private:
        ...
        TIntrusivePtr<TNavigate::TTieredStorageInfo> TieredStorageInfo;
